...
// Se estiver logado como cliente, redireciona para cliente.php
if (isset($_SESSION['usuario_email']) && isset($_SESSION['usuario_tipo'])) {
  ...
  // Se for jardineiro, redireciona para jardineiro.php
  if ($_SESSION['usuario_tipo'] === 'jardineiro') {
    header("Location: jardineiro.php");
    exit();
  }
}

// Se não tiver sessão (visitante), a página inicial continua carregando normalmente
?>
<!DOCTYPE html>
...
<body class="bg-gray-50 text-gray-800">
  ...
  <nav id="navbar" class="fixed w-full top-0 left-0 z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
      ...
      <ul class="hidden md:flex items-center space-x-8 font-medium">
        ...
        <li>
          <a href="#servicos" class="hover:text-green-600 transition duration-200">Serviços</a>
        </li>
        <!-- <li class="relative group">
          <button
            class="flex items-center space-x-1 hover:text-green-600 transition duration-600 focus:outline-none">
            <span>Serviços</span>
            <svg
          ...
          <ul
            ...
            <li>
              <a
                href="#jardinagem"
                class="block px-4 py-2 hover:bg-green-50 hover:text-green-700">Jardinagem</a>
            </li>
            <li>
            ...
            <li>
              <a
                href="#consultoria"
                class="block px-4 py-2 hover:bg-green-50 hover:text-green-700">Consultoria</a>
            </li>
          </ul>
        </li> -->
        <!-- <li>
        ...
        <li>
          <p><a href="logcas.php">login/cadastro</a></p>
    ...
    <div
      ...
      <ul class="flex flex-col px-6 py-4 space-y-2 font-medium">
        ...
        <li>
          <a
            href="#login"
            class="block py-2 px-4 rounded-md bg-green-600 text-white font-semibold text-center hover:bg-green-700">Login / Cadastro</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <section
    ...
    <div class="relative max-w-3xl px-6">
      ...
      <a
        href="#jardineiro"
        class="inline-block mt-10 px-8 py-3 bg-green-600 rounded-lg text-white font-semibold text-lg hover:bg-green-700 transition">Solicite um orçamento</a>
    </div>
  </section>
  ...
  <section id="jardineiro" class="py-20 bg-white">
    <div class="max-w-5xl mx-auto px-6">
      ...
      <form action="enviar.php" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto mb-16">
        <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
          ...
          if (isset($_POST['but'])) {
            ...
            $sql = "INSERT INTO pedidos (nome, localidade, tipo_servico, detalhes) VALUES ('$nome', '$localidade', '$tipo_servico', '$detalhes')";
            $conn->query($sql);
        ...
        <textarea
          ...
          required
          class="md:col-span-2 p-4 border border-gray-300 rounded-lg focus:outline-green-500 focus:ring-2 focus:ring-green-400 resize-none"></textarea>
        <button
          name="but"
          type="submit"
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        ...
        <div class="border border-gray-300 rounded-lg p-6 shadow hover:shadow-lg transition duration-300">
          ...
          <p class="text-green-600 font-semibold mb-4">Contato: (85) 9918-5092</p>
        ...
        <div class="border border-gray-300 rounded-lg p-6 shadow hover:shadow-lg transition duration-300">
          ...
          <p class="text-green-600 font-semibold mb-4">Contato: (85) 98164-8761</p>
          <button class="bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded transition duration-300 w-full">
            Contratar
          </button>
        </div>
  ...
  <footer class="bg-green-800 text-green-100 py-10">
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        ...
        <p class="text-sm">📞 (85) 99257-0119</p>
        <p class="text-sm">📧 contato@jardineiros.com.br</p>
        <p class="text-sm">📍 Rua das Flores, 123 - São Gonsalo, CE</p>
        <div class="flex space-x-4 mt-4">
          <a href="#" aria-label="Facebook" class="hover:text-green-300">
            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
              <path d="M22 12a10 10 0 1 0-11.6 9.8v-6.9h-2v-2.9h2v-2.2c0-2 1.2-3.2 3-3.2.9 0 1.8.1 1.8.1v2h-1c-1 0-1.3.6-1.3 1.2v1.9h2.3l-.4 2.9h-1.9v6.9A10 10 0 0 0 22 12z" />
            </svg>
          </a>
          <a href="#" aria-label="Instagram" class="hover:text-green-300">
            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
              <path d="M7 2C4 2 2 4 2 7v10c0 3 2 5 5 5h10c3 0 5-2 5-5V7c0-3-2-5-5-5H7zm0 2h10c1.7 0 3 1.3 3 3v10c0 1.7-1.3 3-3 3H7c-1.7 0-3-1.3-3-3V7c0-1.7 1.3-3 3-3zm5 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10zm0 2a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm4.8-.2a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z" />
            </svg>
          </a>
          <a href="#" aria-label="Twitter" class="hover:text-green-300">
            <svg class="w-6 h-6 fill-current" viewBox="0 0 24 24">
              <path d="M23 3a10.9 10.9 0 0 1-3.14.86 4.48 4.48 0 0 0 1.98-2.48 9.06 9.06 0 0 1-2.83 1.08 4.52 4.52 0 0 0-7.7 4.12A12.82 12.82 0 0 1 3 4.16a4.52 4.52 0 0 0 1.39 6.05 4.48 4.48 0 0 1-2.05-.57v.06a4.53 4.53 0 0 0 3.62 4.44 4.52 4.52 0 0 1-2.04.08 4.52 4.52 0 0 0 4.21 3.13 9.04 9.04 0 0 1-5.6 1.93A9.27 9.27 0 0 1 2 18.57 12.7 12.7 0 0 0 8.29 20c7.55 0 11.68-6.26 11.68-11.68 0-.18 0-.35-.01-.53A8.18 8.18 0 0 0 23 3z" />
            </svg>
          </a>
        </div>
      </div>
