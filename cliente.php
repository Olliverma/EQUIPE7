...
if (!isset($_SESSION['usuario_email']) || $_SESSION['usuario_tipo'] !== 'cliente') {
...
if (isset($_GET['sucesso']) && $_GET['sucesso'] === 'pedido_enviado') {
  echo '<div class="fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded shadow-lg z-50">
          Pedido enviado com sucesso!
        </div>
        <script>
          setTimeout(() => {
            document.querySelector(".fixed.top-4.right-4").style.display = "none";
            // Remover o parâmetro da URL após exibir
  ...
  <nav id="navbar" class="fixed w-full top-0 left-0 z-50">
    <div class="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
      ...
      <ul class="hidden md:flex items-center space-x-8 font-medium">
        ...
        <li>
          <p><a href="logout.php" class="hover:text-green-600 transition duration-200">Sair</a></p>
        </li>
        <!-- Novo item com o email e foto do usuário -->
        <li class="flex items-center space-x-2">
          <div class="">
            <p class="text-gray-900"><?php echo $_SESSION['usuario_email']; ?></p>
          </div>
          <img
            src="imagens/perfil_padrao.jpg"
            alt="Foto de Perfil"
    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-10">
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm">
          ...
          <li><a href="#contato" class="hover:underline"></a></li>
        </ul>
      </div>

      <div>
        <a href="mailto:contato@jardineiros.com">jardineiroscontato@gmail.com</a>
        <p class="text-sm">📞 (85) 99257-0119</p>
        <p class="text-sm">📧 contato@jardineiros.com.br</p>
        <p class="text-sm">📍 Rua das Flores, 123 - São Gonçalo, CE</p>
