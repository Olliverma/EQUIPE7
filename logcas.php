...
echo " não Entrou";
 ...
 if(isset($_POST['envi'])){
  echo "Entrou";
    ...
    $sql = "INSERT INTO usuarios (email, senha, tipo, localidade) VALUES ('$email', '$senha', '$tipo', '$localidade')";
    $conn->query($sql);
...
<body class="bg-green-50 flex items-center justify-center h-screen">
  <div class="bg-white p-8 rounded-xl shadow-md w-full max-w-md" id="formBox">
    ...
    <form id="authForm" method="POST" action="logcas.php">
      <div class="mb-4">
      ...
      <div class="flex justify-between mt-6">
        <div class="flex justify-between mt-6">
  <button type="submit" name="envi" class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700" id="btnEnviar">
    Entrar
  </button>
</div>
...
<script>
  document.getElementById('btnEnviar').addEventListener('click', function(e) {
    ...
    // window.location.href = 'cliente.php';
       ...
       <button id="botaoAlternarModo" type="button" onclick="alternarModo()" class="text-green-700 underline">
  ...
  document.getElementById("botaoAlternarModo").textContent = modoCadastro ? "Trocar para Login" : "Trocar para Cadastro"; // ← linha adicionada
